jQuery(document).ready(function ($) {
    ...
    mywindow.scroll(function () {
        if (mywindow.scrollTop() == 0) {
            ...
            $('.navbar-nav li[data-slide-parallax="7"]').addClass('active');
            $('.navbar-nav li[data-slide-parallax="8"]').removeClass('active');
            $('.navbar-nav li[data-slide-parallax="6"]').removeClass('active');
        }
